-- Migration: 00327_add_bl_number_to_v_containers
-- Recreates v_containers with bill_of_lading_number joined from portix.documents.
-- This avoids N+1 queries in dashboard tables that need to display the B/L number.
...
COMMENT ON VIEW portix.v_containers IS
    'Enriched container view with shipment, party names, and B/L number pre-joined. Use for all dashboard queries.';
