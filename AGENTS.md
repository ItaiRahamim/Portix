# AGENTS.md — Portix Project Guide

## Workflow Strategy
- **Context First**: Before scanning the codebase or executing complex tasks, always read this file (`AGENTS.md`) and `knowledge/ERRORS.md`.
...
> Current product docs: `README.md`, `PRD_V2_Draft.md`, `knowledge/DEPLOYMENT_STATUS.md`
...
- When you discover something new, **don't wait** — propose edits to AGENTS.md and commit immediately.
