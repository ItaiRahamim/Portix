  ...
  const roles = [
    {
      ...
      path: "/importer",
      color: "bg-blue-600",
      screens: ["Container Control", "Container Details", "Accounts", "Claims", "Licenses", "Missing Docs"],
    },
    {
      title: "Supplier",
      ...
      path: "/supplier",
      color: "bg-green-600",
      screens: ["Container Overview", "Container Details", "Cargo Photos", "Accounts", "Missing Docs"],
    },
    {
      title: "Customs Agent",
      ...
      path: "/customs-agent",
      color: "bg-purple-600",
      screens: ["Container Review Queue", "Container Details", "Accounts", "Missing Docs"],
    },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white border-b">
        <div className="container mx-auto px-4 py-6 flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl text-gray-900">ClearPort</h1>
            <p className="text-gray-500 text-sm">Import/Export Document Management Platform</p>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500">Choose your role to access the appropriate dashboard and screens</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {roles.map((role) => {
              ...
              return (
                <Card key={role.path} className="hover:shadow-lg transition-shadow cursor-pointer group" onClick={() => navigate(role.path)}>
                  <CardHeader>
